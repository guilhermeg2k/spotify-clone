...
function Footer() {
  return (
    <div id="footer-container" className="container white">
      <footer>
        <div id="ft-logo">
          <a
      ...
      <footer id="second-footer">
        <div id="country-links">
          <span>Brasil</span>
          <img
            src="https://country-flags.scdn.co/flags/br.svg"
            alt="Brazil's flag"
          />
        </div>
        <div id="bottom-links">
