const plans = [
  {
    ...
    freeTimeInMonths: 3,
    agreements:
      'O período de 3 meses grátis não está disponível para usuários que já experimentaram o Premium. Sujeito a Termos e condições. Válido até 31 de dez de 2020.',
    prePaidPlans: true,
  },
  {
    name: 'Duo',
    ...
    freeTimeInMonths: 1,
    agreements:
      'São aplicáveis termos e condições. O mês grátis não está disponível para usuários que já experimentaram o Premium.',
    prePaidPlans: false,
  },
  {
    name: 'Família',
  ...
  },
  {
    ...
    freeTimeInMonths: 1,
    agreements:
      'Plano disponível somente para estudantes universitários de instituições de ensino superior aprovadas. O mês grátis não está disponível para usuários que já experimentaram o Premium. São aplicáveis os termos e condições da oferta do Spotify de desconto para universitários.',
    prePaidPlans: false,
  },
];
const fakeData = {
